const HeroSection = () => {
  return (
    <section id="home" className="min-h-screen w-full pl-32 flex items-center px-6 pt-20">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex justify-center">
          <img src="/images/deep.jpg" alt="John Doe" className="w-80 h-80 object-cover rounded-2xl" />
        </div>
      </div>
    </section>
  );
